...
counts<-read.table("D:/南开/国创/数据/GSE75748（Chu）/GSE75748_sc_time_course_ec.csv/GSE75748_sc_time_course_ec.csv",sep=",",header=T)
...
save(SR.v,file="D:/南开/国创/数据/SR.v/GSE75748Chu2.SR.Rdata");
#load("D:/南开/国创/数据/SR.v/GSE75748Chu2.SR.Rdata");

##Calculation of NCG
source('D:/南开/国创/终极版/需要的函数/CompECC.R');
source('D:/南开/国创/终极版/需要的函数/CompNCG.R');
ECC<-CompECC(int.o$adjMC);
save(ECC,file="D:/南开/国创/数据/ECC.m/GSE75748Chu2.RData");
#load("D:/南开/国创/数据/ECC.m/GSE75748Chu2_ECC.RData");
load("D:/南开/国创/代码/slice/data/hs_km.Rda");
NCG<-CompNCG(ECC,int.o$expMC,km);
save(NCG,file="D:/南开/国创/数据/NCG.v/GSE75748Chu2_NCG.RData");
#load("D:/南开/国创/数据/NCG.v/GSE75748Chu2_NCG.RData");
